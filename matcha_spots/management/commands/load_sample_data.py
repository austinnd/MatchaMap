    ...
    def handle(self, *args, **options):
        sample_spots = [
            ...
            },
            {
                ...
                'rating': 4.4,
                'review_count': 119,
                'description': 'Local roaster with a calm study vibe and a smooth, lightly sweet matcha latte.',
                'phone': '+(949) 612-2875',
            ...
            },
            {
                ...
                'rating': 3.9,
                'review_count': 57,
                'description': 'Casual Asian-fusion spot; simple matcha drinks to pair with comfort snacks.',
                'phone': 'n/a',
            ...
            },
            {
                ...
                'rating': 4.1,
                'review_count': 62,
                'description': 'Campus café staple pouring classic matcha lattes and quick breakfast pastries.',
                'phone': '(949) 690-3075',
            ...
            },
            {
                ...
                'rating': 4.5,
                'review_count': 67,
                'description': 'Bakery chain featuring matcha lattes plus cakes, croissants, and seasonal desserts.',
                'phone': '(949) 800-8885',
            ...
            },
            {
                ...
                'rating': 4.7,
                'review_count': 112,
                'description': 'Minimal Japanese-style café serving matcha lattes, soft serve, and light bites.',
                'phone': '(949) 400-9314',
                'website': 'n/a',
            ...
            },
            {
                ...
                'rating': 4.5,
                'review_count': 42,
                'description': 'Trendy Taiwanese-American café with inventive drinks; layered strawberry and oat matcha are favorites.',
                'phone': 'n/a',
            ...
            },
            {
                ...
                'rating': 4.3,
                'review_count': 71,
                'description': 'Hand-whisked ceremonial-grade matcha with fruit blends and build-your-own sweetness.',
                'phone': '(949) 404-1000',
            ...
            },
            {
                ...
                'rating': 3.8,
                'review_count': 110,
                'description': 'House-made boba with chewy textures; solid matcha milk tea and seasonal specials.',
                'phone': '(949) 783-9808',
            ...
            },
            {
                ...
                'rating': 4.7,
                'review_count': 61,
                'description': 'Boutique tea house offering premium leaves and a silky, balanced matcha latte.',
                'phone': '(657) 462-5587',
